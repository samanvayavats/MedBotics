  ...
  return (
    <div className='h-full  mt-24 w-full flex items-center justify-center '>
      <div className='flex flex-col justify-center items-center bg-transparent '>
        <div className='flex flex-row-reverse  items-center justify-around e md:w-72 w-60'>
          <img src="robot.png"
            className='h-20'
            alt="error" />
          <h1
        ...
        <p className='text-amber-50'>Not <span className='text-primary-500'>Sign-up</span> Yet ?
        <Link href='/signup'>
        <span className='hover:underline hover:text-primary-500'> SIGN-UP</span>
        </Link>
        </p>
      </div>
    </div>
